...
package com.pixeldust.settings.security.applock
...
import com.pixeldust.settings.preference.PixeldustDashboardFragment

private val TAG = AppLockPackageConfigFragment::class.simpleName
private const val KEY_HEADER = "header_view"

class AppLockPackageConfigFragment : PixeldustDashboardFragment() {
